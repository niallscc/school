...
public class RectangleTest {
	...
	public void testDiagonal() {
		...
		assertEquals(r.diagonal(), Math.sqrt(2),0.0);
...
/* The following test methods were not written in class */	
	...
	public void testIsSquare() {
		Rectangle t = new Rectangle(2, 0, 2, 1);
		assertEquals(t.isSquare(), false);
		Rectangle t2 = new Rectangle(2,2,1,1);
		assertEquals(t2.isSquare(), true);
	}
	@Test
	public void testIsRectangle() {
		Rectangle t = new Rectangle(2, 0, 2, 1);
		assertEquals(t.isRectangle(), true);
		Rectangle t2 = new Rectangle(2,2,1,1);
		assertEquals(t2.isRectangle(), false);
	}
}
