function web_final(){
  ...
  $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('web_final');
      ...
      web_final = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'web_final', base, softPermutationId);
      $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('web_final.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_web_final';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_0) {
        name_0 = name_0.replace('web_final::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  web_final.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  web_final.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('web_final'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?web_final';
    strongName = '';
  }
  $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['gecko1_8'], '064F60542938213848459ED510F47C94');
      unflattenKeylistIntoAnswers(['ie9'], '341ADCE3C7A81070A16C05BE973923E1');
      unflattenKeylistIntoAnswers(['ie6'], '8E516E9BED613C49ED66FA9FC62DA5BB');
      unflattenKeylistIntoAnswers(['safari'], '8ED918A2335C3781DFF14D7D3EA8642F');
      unflattenKeylistIntoAnswers(['ie8'], '9F66AF51A001090F66E58CD77FE96C16');
      unflattenKeylistIntoAnswers(['opera'], 'EDE7BE93E9565D8903949EF69FAEC360');
  ...
  , 50);
  $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'web_final', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">web_final.onInjectionDone(\'web_final\')<\/script>');
}
